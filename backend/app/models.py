...
class UserProfile(Base):
    ...
    show_in_progress: Mapped[bool] = mapped_column(Boolean, default=False)
    show_personal_cv: Mapped[bool] = mapped_column(Boolean, default=False)
    show_generated_cv: Mapped[bool] = mapped_column(Boolean, default=False)

    # CV Configuration (stored as JSON)
    cv_config: Mapped[Optional[dict]] = mapped_column(JSON, nullable=True)
